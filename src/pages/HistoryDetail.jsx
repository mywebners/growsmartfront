      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-[#1a1a1a] mb-2">{record.career}</h1>
        ...
        <motion.div className="glass-card p-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {matricMarks.length > 0 ? (
              ...
              <p className="text-[#6a6a6a]">No matric data</p>
            )}
          </div>
        </motion.div>
        ...
        <motion.div className="glass-card p-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {intermediateMarks.length > 0 ? (
              ...
              <p className="text-[#6a6a6a]">No intermediate data</p>
            )}
          </div>
        </motion.div>
        ...
        <motion.div className="glass-card p-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {skillsRaw.length > 0 ? (
              ...
              <p className="text-[#6a6a6a]">No skills data</p>
            )}
          </div>
        </motion.div>
      </div>

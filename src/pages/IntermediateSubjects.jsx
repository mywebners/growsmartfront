      ...
      <div className="relative z-10 pt-20 sm:pt-24 pb-16 sm:pb-20 px-3 max-[320px]:px-2 sm:px-4">
        <div className="max-w-2xl mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-2xl min-[321px]:text-4xl sm:text-5xl md:text-6xl font-black bg-gradient-to-r from-[#003a9b] via-[#0056d2] to-[#2f7de1] bg-clip-text text-transparent mb-3 sm:mb-4 px-1 break-anywhere">
            ...
            <p className="text-base sm:text-xl text-[#5b5b5b] max-w-lg mx-auto px-1">
              ...
              {stream?.replace("-", " ")}). From <span className="text-[#9ec5ff] font-semibold">{MARK_MIN}</span> to{" "}
              <span className="text-[#9ec5ff] font-semibold">{MARK_MAX}</span>.
            </p>
